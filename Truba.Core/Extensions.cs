...
public static class Extensions
{
    ...
    public static Pipe<T> PipeV<T>(this T value) => 
        Logic.GetPipeV(value);
    ...
    public static Task<T> Value<T>(this AsyncPipe<T> asyncPipe) => 
        Logic.GetValue(asyncPipe);

    public static AsyncPipe<T> PipeVAsync<T>(this Task<T> value) => 
        Logic.GetPipeVAsync(value);
